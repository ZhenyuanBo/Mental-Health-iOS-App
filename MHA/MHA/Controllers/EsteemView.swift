/*
 Author: Zhenyuan Bo
 File Description: presents the esteem level
 Date: Nov 23, 2020
 */
...
class EsteemView: UIView {
    ...
    func createEsteemLevel() {
        ...
        path.addLine(to: CGPoint(x: self.frame.size.width*0.6, y: 0.0))
        path.close()
    }
    ...
    override func draw(_ rect: CGRect) {
        ...
        if activityList.count>0{
            ...
            if activityList.count==1{
                ...
                gradient.locations = [0.0, 0.2, 0.4, 0.6, 0.8, 0.9]
            }else if activityList.count==6{
                gradient.locations = [0.0, 0.2, 0.4, 0.6, 0.8, 0.9, 1.0]
            }
